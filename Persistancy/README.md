...
HTTP - hypertext transfer protocol. Kommunicerar genom webben med: Protocol :// host : port / path. Finns diverse kommandon som beskriver vilken typ av kommunikation man vill utföra. Där de viktigaste är.
